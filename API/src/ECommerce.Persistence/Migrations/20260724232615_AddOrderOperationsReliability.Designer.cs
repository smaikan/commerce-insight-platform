...
namespace ECommerce.Persistence.Migrations
{
    ...
    [Migration("20260724232615_AddOrderOperationsReliability")]
    partial class AddOrderOperationsReliability
    {
        /// <inheritdoc />
        // Burada operasyonel sipariş migration'ının EF Core model snapshot'ını oluşturuyorum.
            ...
            modelBuilder.Entity("ECommerce.Domain.Entities.InventoryTransaction", b =>
                {
                    ...
                    b.HasIndex("ReturnRequestId", "ProductVariantId")
                        .IsUnique()
                        .HasFilter("[ReturnRequestId] IS NOT NULL AND [Type] = 'Return'");
