# DELETE /api/accounting/sales-orders/{id}/items/{itemId}

- Görev alanı: **Muhasebe → Satış siparişleri**.
- İşlev: Sipariş kalemini siler.
- Operation ID: `DELETE-/api/accounting/sales-orders/{id}/items/{itemId}`
- Yetki: **Admin**.
