# GET /api/accounting/reports/purchase-invoices/{id}

- Görev alanı: **Muhasebe → Raporlar → Alış raporları**.
- İşlev: Filtrelenebilir muhasebe rapor verisini sayfalı olarak okur.
- Operation ID: `GET-/api/accounting/reports/purchase-invoices/{id}`
- Yetki: **Admin**.
