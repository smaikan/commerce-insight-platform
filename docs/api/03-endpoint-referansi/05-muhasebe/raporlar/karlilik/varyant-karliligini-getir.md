# GET /api/accounting/reports/profitability/product-variants

- Görev alanı: **Muhasebe → Raporlar → Kârlılık raporları**.
- İşlev: Filtrelenebilir muhasebe rapor verisini sayfalı olarak okur.
- Operation ID: `GET-/api/accounting/reports/profitability/product-variants`
- Yetki: **Admin**.
