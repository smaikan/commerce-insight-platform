# GET /api/accounting/reports/stock-movements/partially-costed

- Görev alanı: **Muhasebe → Raporlar → Stok ve maliyet raporları**.
- İşlev: Filtrelenebilir muhasebe rapor verisini sayfalı olarak okur.
- Operation ID: `GET-/api/accounting/reports/stock-movements/partially-costed`
- Yetki: **Admin**.
