# GET /api/accounting/reports/current-accounts/{id}/statement

- Görev alanı: **Muhasebe → Raporlar → Cari ve tahsilat raporları**.
- İşlev: Filtrelenebilir muhasebe rapor verisini sayfalı olarak okur.
- Operation ID: `GET-/api/accounting/reports/current-accounts/{id}/statement`
- Yetki: **Admin**.
