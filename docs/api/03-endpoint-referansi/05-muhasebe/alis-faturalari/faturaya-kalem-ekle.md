# POST /api/accounting/purchase-invoices/{id}/lines

- Görev alanı: **Muhasebe → Alış faturaları**.
- İşlev: Faturaya kalem ekler.
- Operation ID: `POST-/api/accounting/purchase-invoices/{id}/lines`
- Yetki: **Admin**.
...
| Alan | Tip | Zorunlu |
| --- | --- | --- |
| `lineNumber` | integer (int32) | Evet |
| `productVariantId` | string (uuid) | Evet |
