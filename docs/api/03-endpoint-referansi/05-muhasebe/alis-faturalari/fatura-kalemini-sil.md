# DELETE /api/accounting/purchase-invoices/{id}/lines/{lineId}

- Görev alanı: **Muhasebe → Alış faturaları**.
- İşlev: Fatura kalemini siler.
- Operation ID: `DELETE-/api/accounting/purchase-invoices/{id}/lines/{lineId}`
- Yetki: **Admin**.
