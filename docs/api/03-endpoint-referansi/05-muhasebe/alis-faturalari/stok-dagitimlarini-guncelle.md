# PUT /api/accounting/purchase-invoices/{id}/lines/{lineId}/allocations

- Görev alanı: **Muhasebe → Alış faturaları**.
- İşlev: Stok dagitimlarini günceller.
- Operation ID: `PUT-/api/accounting/purchase-invoices/{id}/lines/{lineId}/allocations`
- Yetki: **Admin**.
