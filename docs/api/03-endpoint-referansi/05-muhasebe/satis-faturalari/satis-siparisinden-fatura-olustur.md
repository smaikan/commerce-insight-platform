# POST /api/accounting/sales-invoices/from-order/{accountingSalesOrderId}

- Görev alanı: **Muhasebe → Satış faturaları**.
- İşlev: Satış siparisinden fatura oluşturur.
- Operation ID: `POST-/api/accounting/sales-invoices/from-order/{accountingSalesOrderId}`
- Yetki: **Admin**.
...
| --- | --- | --- | --- |
| `accountingSalesOrderId` | path | Evet | string (uuid) |
