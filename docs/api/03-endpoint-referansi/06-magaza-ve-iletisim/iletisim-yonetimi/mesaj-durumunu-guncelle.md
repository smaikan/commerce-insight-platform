...
Aynı durumdan aynı duruma geçiş geçersizdir. Başarı güncel `ContactMessageDetailDto` ve yenilenmiş `concurrencyToken` döndürür. Alan sözleşmesi için [ortak sözleşme](ortak-sozlesme.md#contactmessagedetaildto) tablosuna bakın.
