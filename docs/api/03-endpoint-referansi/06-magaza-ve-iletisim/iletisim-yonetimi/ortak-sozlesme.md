# İletişim mesajları ortak sözleşmesi

- [POST /api/contact-messages](../iletisim-formu/mesaj-gonder.md)
- [GET /api/contact-messages](listele.md)
- [GET /api/contact-messages/{id}](mesaj-detayini-getir.md)
- [PATCH /api/contact-messages/{id}/status](mesaj-durumunu-guncelle.md)
- [PATCH /api/contact-messages/{id}/assignment](mesaji-ata.md)
- [POST /api/contact-messages/{id}/notes](dahili-not-ekle.md)
- [POST /api/contact-messages/{id}/replies](musteriye-yanit-gonder.md)
