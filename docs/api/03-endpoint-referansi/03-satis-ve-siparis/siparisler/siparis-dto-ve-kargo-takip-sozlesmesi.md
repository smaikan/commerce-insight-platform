...
Varyant adı ve değeri de canlı katalogdan yeniden okunmaz. Varyantsız ürünlerde teknik tek-varyant metni yerine `variantName=null` ve `variantValue=null` döner. Tam kullanım kuralı [varyant snapshot sözleşmesinde](../sepet/varyant-snapshot-sozlesmesi.md) açıklanır.
