...
```json
{
  ...
  "shippingAddress": {
    "sourceAddressId": "d7df4362-ccaf-4c9f-8dfd-144959e52931",
    "city": "İstanbul"
  },
  "billingAddress": {
    "sourceAddressId": "d7df4362-ccaf-4c9f-8dfd-144959e52931",
...
`OrderItemDto.variantName` ve `variantValue` checkout anındaki değişmez snapshot'lardır; varyantsız veya eski siparişte `null` olabilir. Ayrıntı: [varyant snapshot sözleşmesi](../../sepet/varyant-snapshot-sozlesmesi.md).
