...
`200` ve `202` JSON biçimleri [üye sipariş iptali sözleşmesindekiyle](../uye/siparisi-iptal-et.md) aynıdır. `202` frontend başarısı değildir; polling başlatır. Mutation tamamlanınca sepet yeniden oluşturulmaz, guest cookie değişmez ve response PII/provider kimliği taşımaz.
