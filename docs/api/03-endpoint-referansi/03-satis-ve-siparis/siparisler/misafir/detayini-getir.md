...
Guest session'ın grant aldığı tek siparişin kalem, müşteri, shipping/billing, kargo ve ödeme snapshot'larını döndürür. Ürün medya snapshot'ları ve kargo takip geçmişi için [ortak OrderDto sözleşmesine](../siparis-dto-ve-kargo-takip-sozlesmesi.md), varyant adı/değeri için [varyant snapshot sözleşmesine](../../sepet/varyant-snapshot-sozlesmesi.md) bakın.
