...
Başarı `200` ve kalemleriyle `ReturnRequestDto`; alanlar ve örnek response gövdesi [üye iade detayı sözleşmesindekiyle](../uye/detayini-getir.md) aynıdır. Cookie değişmez, cevap `no-store` olmalıdır.
