...
Başarı `201 Created` ve `ReturnRequestDto`; örnek response gövdesi [üye iade talebi oluşturma sözleşmesindekiyle](../uye/olustur.md) aynıdır. Cookie değişmez. Sipariş `ReturnRequested` olur, outbox bildirimi checkout cevabını bekletmez.
