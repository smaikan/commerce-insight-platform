...
- Görev alanı: **Satış ve sipariş → Checkout → Misafir işlemleri**.
...
```json
{
  ...
  "payments": [],
  "reservationExpiresAt": "2026-08-03T12:15:00Z",
  "createdAt": "2026-08-03T12:00:00Z"
}
```

`variantName` ve `variantValue` checkout anında sipariş kalemine snapshot'lanır; varyantsız üründe veya eski siparişte `null` olabilir. Ayrıntı: [varyant snapshot sözleşmesi](../../sepet/varyant-snapshot-sozlesmesi.md).
