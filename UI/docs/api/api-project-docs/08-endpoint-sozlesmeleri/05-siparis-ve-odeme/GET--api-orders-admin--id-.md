...
Response içindeki ürün medya snapshot'larý ve kargo takip geçmiþi için [ortak OrderDto sözleþmesine](ORDER-DTO-VE-KARGO-TAKIP-SOZLESMESI.md), varyant adý/deðeri için [varyant snapshot sözleþmesine](../04-sepet/SEPET-SIPARIS-VARYANT-SNAPSHOT-SOZLESMESI.md) bakýn.
