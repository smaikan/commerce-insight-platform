...
// Burada statik bilgilendirme ile siparişe özgü kurulacak sözleşmenin sınırını açıkça koruyorum.
const sections: LegalSection[] = [
  ...
  },
  {
    ...
    content: <><p>Alıcı, sipariş sırasında iletişim ve teslimat bilgilerini veren tüketicidir. Satıcıya ait bağlayıcı kimlik ve iletişim bilgileri siparişe özel ön bilgilendirme formu ile sözleşmede yer alır.</p><SellerIdentity /></>,
  },
  {
    id: "order",
...
// Burada mesafeli satış sayfasını etkileşimsiz Server Component olarak ilk HTML içinde sunuyorum.
