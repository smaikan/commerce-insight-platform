...
export default async function Home() {
  const [
    ...
    getPublishedProducts({ SortBy: 4, Descending: true, PageSize: 8, PageNumber: 1 }).catch(() => null),
    getPublishedProducts({ SortBy: 0, Descending: true, PageSize: 8, PageNumber: 1 }).catch(() => null),
