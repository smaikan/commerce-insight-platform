...
export default function CollectionsLoading() {
  return (
    <main id="main-content" className="flex-1 pb-12 sm:pb-16" aria-busy="true" aria-label="Koleksiyonlar yükleniyor">
      ...
      {/* Burada yükleme iskeletini gerçek listeyle aynı tablet ve masaüstü üç sütun geometrisinde tutuyorum. */}
