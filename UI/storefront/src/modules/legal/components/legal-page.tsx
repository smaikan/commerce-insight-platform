    ...
    <main id="main-content" className="flex-1 pb-12 sm:pb-16">
      <header className="border-b border-line bg-surface">
        <div className="page-shell py-8 sm:py-10 lg:py-12">
          ...
          <div className="mt-0 max-w-3xl sm:mt-5">
      ...
      <div className="page-shell grid items-start gap-8 pt-6 lg:grid-cols-[15rem_minmax(0,46rem)] lg:justify-center lg:gap-12 lg:pt-8">
        ...
        <article className="min-w-0">
          {notice ? (
            <div className="mb-6 border-l-4 border-brand-600 bg-surface-subtle px-4 py-4 text-sm leading-6 text-ink sm:px-5">
              {notice}
            </div>
          ) : null}

          {sections.map((section, index) => (
            <section key={section.id} id={section.id} className="scroll-mt-24 border-b border-line py-7 first:pt-0 last:border-b-0 last:pb-0" aria-labelledby={`${section.id}-title`}>
