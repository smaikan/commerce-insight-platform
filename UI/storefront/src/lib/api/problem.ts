...
export function normalizeApiProblem(status: number, value: unknown, retryAfter?: string | null): ApiProblem {
  if (!value || typeof value !== "object") {
    return { title: "İstek tamamlanamadı", status, retryAfter: retryAfter || undefined };
  }
